...
static void mymemcpy ( void *des, void *src, INT32U n ) { /* 复制内存 */
    INT8U *xdes = des;
    INT8U *xsrc = src;
...
static void mymemset ( void *s, INT8U c, INT32U count ) { /* 设置内存 */
    INT8U *xs = s;
...
static INT8U mem_perused ( void ) { /* 获取内存使用率 */
    INT32U used = 0;
    INT32U i;
...
static INT32U mem_malloc ( INT32U size ) { /* 内存分配(内部调用) */
    INT32S offset = 0;
...
static INT8U mem_free ( INT32U offset ) { /* 释放内存(内部调用) */
    int i;
...
void myfree ( void *ptr ) { /* 释放内存(外部调用) */
    INT32U offset;
...
void *mymalloc ( INT32U size ) { /* 分配内存(外部调用) */
    INT32U offset;
...
void *myrealloc ( void *ptr, INT32U size ) { /* 重新分配内存(外部调用) */
    INT32U offset;
    offset = mem_malloc ( size );
